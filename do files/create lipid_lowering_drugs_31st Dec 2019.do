...
/*generate indicator for taking lipid_lowering_drugs on 31st Dec 2019*/
/*use 3 month window -if prescribed lipid_lowering_drugs in 3 month period before 31st Dec 2019 count as on lipid_lowering_drugs*/

gen lipid_lowering_drugs_dec19=1 if lipid_lowering_drugs==1 & issuedate<td(31dec2019) & issuedate>=td(30sept2019)

label variable lipid_lowering_drugs "ever prescribed lipid_lowering_drugs"
label variable lipid_lowering_drugs_dec19 "using lipid_lowering_drugs on 31st Dec 2019"

keep if lipid_lowering_drugs_dec19==1

egen keepme=tag(patid)

keep if keepme==1

keep patid lipid_lowering_drugs_dec19 issuedate prodcodeid dosageid quantity quantunitid duration route formulation strength bnfcode
