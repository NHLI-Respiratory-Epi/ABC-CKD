...
gen ddp4_dec19=1 if ddp4==1 & issuedate<td(31dec2019) & issuedate>=td(30sept2019)

label variable ddp4 "ever prescribed ddp4"
label variable ddp4_dec19 "using ddp4 on 31st Dec 2019"

keep if ddp4_dec19==1

egen keepme=tag(patid)

keep if keepme==1

keep patid ddp4_dec19 
