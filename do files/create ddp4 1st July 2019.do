...
/*generate indicator for taking ddp4 on 31st Dec 2019 - using codelist developed by Sarah Cook*/
/*use 3 month window -if prescribed ddp4 in 3 month period before 1st Jan 2017 count as on ddp4*/

gen ddp4_july19=1 if ddp4==1 & issuedate<td(01july2019) & issuedate>=td(01april2019)

label variable ddp4 "ever prescribed ddp4"
label variable ddp4_july19 "using ddp4 on 1st July 2019"

keep if ddp4_july19==1

egen keepme=tag(patid)

keep if keepme==1

keep patid ddp4_july19 
