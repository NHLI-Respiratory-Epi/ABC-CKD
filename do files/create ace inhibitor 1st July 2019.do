...
/*use 3 month window -if prescribed ACE-I in 3 month period before 1st July 2019 count as on ace-i*/

gen acei_july19=1 if acei==1 & issuedate<td(01july2019) & issuedate>=td(01april2019)


label variable acei "ever prescribed acei"
label variable acei_july19 "using acei on 1st July 2019"

keep if acei_july19==1

egen keepme=tag(patid)

keep if keepme==1

keep patid acei_july19
